...
def build_discriminator(x, discrim_network, reuse=False):
    """
...
class GAN(object):
    ...
    def __init__(self, input_size, z_size, gen_network, discrim_network):
        ...
        self.discrim_data = build_discriminator(x, discrim_network)
        self.discrim_gen = build_discriminator(self.generator, discrim_network,
                                               True)
